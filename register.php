	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-center">
			...
			<div class="logo top_align">
				<a href="#"></a>
				<div>fitness <span>z</span></div>
				<div>the best results</div>
			</div>
			<nav class="main_nav">
			...
			<div class="header_right top_align d-flex flex-row align-items-center justify-content-start">
				...
				<div class="contact_button trans_400"><a href="#">Get in touch</a></div>
...
<form action="save.php" method="post" name="regform">
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt=""/>
                        <h3>Welcome</h3>
                        <p>You are 30 seconds away from your journey to your fitness goals!</p>
                    ...
                    <input id="name" type="text" name="name" class="form-control" placeholder="Enter your name*" required="required" data-error="Valid email is required.">
                    </div>
                    <div class="help-block with-errors"></div>

                    <div class="form-group">
                    <input id="designation" type="text" name="designation" class="form-control" placeholder="Enter your Job Title*"  required="required" value=""/>
                    </div>
                    <div class="help-block with-errors"></div>
                   
                                         <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Enter Your Email Address *" name="email" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>


                                        <div class="form-group">
                                            <input type="date" class="form-control" placeholder="Enter Your Date of Birth *" name="dob"  value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>

                                        <div class="form-group">
                                            <input type="website" class="form-control" placeholder="Enter Your Website*" name="site" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>

                                        <div class="form-group">
                                            <input type="number" maxlength="10" minlength="10" class="form-control" placeholder="Enter Your Phone Number *" name="phone" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>

                                          <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Current Location *" name="location" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Home Address *" name="home-address" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Current Employment Details *" name="current-employer" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>

                                      <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Previous Employment Details *" name="previous-employer" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>


                                         <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Skills*" name="skills" value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>


                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Work Address *" name="work-address"  value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>
                                         
            
                                            <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Previous Work Address *" name="pwork-address"  value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>
                                        ...
                                        <div class="help-block with-errors"></div>
                                         ...
                                         <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Re-enter Your Password *" name="pass_confirm"  value="" />
                                        </div>
                                        <div class="help-block with-errors"></div>
                    <div>  
...
<h5 class="widget-title">FITNESS Z<span></span></h5>
